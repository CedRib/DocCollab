...
using DocCollabBackend.Services;
using DocCollabBackend.Hubs;
using Microsoft.AspNetCore.Builder;
using DocCollabBackend.Model;

namespace DocCollabBackend.Controllers
{
    ...
    public class CollaborativeEditingController : ControllerBase
    {
        ...
        public async Task<string> ImportFile([FromBody] DocCollabBackend.Model.FileInfo param)
        {
            try
            {
